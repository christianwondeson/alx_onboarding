const loggedUser = '{{@user.username}}';
    ...
    if (tab === "1") {
      ...
      function getTransactionDetailsByPaymentMethod(pageNumber, limit) {
        axios
          .get(`${hostName}/api/transactions/get_transaction_details_by_payment_method?terminalID=${terminalID}&headerValue=${headerValue}&bank=${first_field}&loggedUser=${loggedUser}&page=${pageNumber}&limit=${limit}`)
          .then(response => {
            ...
            generatePagination(metadata.pagination, getTransactionDetailsByPaymentMethod);
      ...
      $(document).ready(function () {
        getTransactionDetailsByPaymentMethod(1, 15);
      });
